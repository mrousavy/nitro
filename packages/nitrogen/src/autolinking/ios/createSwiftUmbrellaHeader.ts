...
#if TARGET_OS_VISION && TARGET_OS_SIMULATOR && __has_include("GeneratedModuleMaps-xrsimulator/${moduleName}-Swift.h")
#include "GeneratedModuleMaps-xrsimulator/${moduleName}-Swift.h"
#elif TARGET_OS_VISION && __has_include("GeneratedModuleMaps-xros/${moduleName}-Swift.h")
#include "GeneratedModuleMaps-xros/${moduleName}-Swift.h"
#elif TARGET_OS_SIMULATOR && __has_include("GeneratedModuleMaps-iphonesimulator/${moduleName}-Swift.h")
#include "GeneratedModuleMaps-iphonesimulator/${moduleName}-Swift.h"
#elif !TARGET_OS_SIMULATOR && __has_include("GeneratedModuleMaps-iphoneos/${moduleName}-Swift.h")
#include "GeneratedModuleMaps-iphoneos/${moduleName}-Swift.h"
#else
