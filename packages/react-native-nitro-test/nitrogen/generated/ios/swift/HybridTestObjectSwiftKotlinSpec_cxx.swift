...
open class HybridTestObjectSwiftKotlinSpec_cxx {
  ...
  @inline(__always)
  public final func tryOptionalStruct(value: bridge.std__optional_OptionalWrapper_) -> bridge.Result_std__optional_OptionalWrapper__ {
    do {
      let __result = try self.__implementation.tryOptionalStruct(value: value.value)
      let __resultCpp = { () -> bridge.std__optional_OptionalWrapper_ in
        if let __unwrappedValue = __result {
          return bridge.create_std__optional_OptionalWrapper_(__unwrappedValue)
        } else {
          return .init()
        }
      }()
      return bridge.create_Result_std__optional_OptionalWrapper__(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__optional_OptionalWrapper__(__exceptionPtr)
    }
  }
  
  @inline(__always)
  public final func tryOptionalNestedStruct(value: bridge.std__optional_OptionalNestedWrapper_) -> bridge.Result_std__optional_OptionalNestedWrapper__ {
    do {
      let __result = try self.__implementation.tryOptionalNestedStruct(value: value.value)
      let __resultCpp = { () -> bridge.std__optional_OptionalNestedWrapper_ in
        if let __unwrappedValue = __result {
          return bridge.create_std__optional_OptionalNestedWrapper_(__unwrappedValue)
        } else {
          return .init()
        }
      }()
      return bridge.create_Result_std__optional_OptionalNestedWrapper__(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__optional_OptionalNestedWrapper__(__exceptionPtr)
    }
  }
