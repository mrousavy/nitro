...
open class HybridTestObjectSwiftKotlinSpec_cxx {
  ...
  @inline(__always)
  public final func bounceExternalHybrid(externalObject: bridge.std__shared_ptr_margelo__nitro__nitrotestexternal__HybridSomeExternalObjectSpec_) -> bridge.Result_std__shared_ptr_margelo__nitro__nitrotestexternal__HybridSomeExternalObjectSpec__ {
    do {
      let __result = try self.__implementation.bounceExternalHybrid(externalObject: { () -> HybridSomeExternalObjectSpec in
        let __unsafePointer = bridge.get_std__shared_ptr_margelo__nitro__nitrotestexternal__HybridSomeExternalObjectSpec_(externalObject)
      ...
      let __resultCpp = { () -> bridge.std__shared_ptr_margelo__nitro__nitrotestexternal__HybridSomeExternalObjectSpec_ in
        let __cxxWrapped = __result.getCxxWrapper()
        return __cxxWrapped.getCxxPart()
      }()
      return bridge.create_Result_std__shared_ptr_margelo__nitro__nitrotestexternal__HybridSomeExternalObjectSpec__(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_std__shared_ptr_margelo__nitro__nitrotestexternal__HybridSomeExternalObjectSpec__(__exceptionPtr)
    }
  }
}
