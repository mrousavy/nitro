...
open class HybridTestObjectSwiftKotlinSpec_cxx {
  ...
  @inline(__always)
  public final func promiseWithUndefinedResult() -> bridge.Result_std__shared_ptr_Promise_std__optional_double____ {
    do {
      let __result = try self.__implementation.promiseWithUndefinedResult()
