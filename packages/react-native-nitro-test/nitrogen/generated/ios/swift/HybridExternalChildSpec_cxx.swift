 ...
 */
open class HybridExternalChildSpec_cxx : HybridSomeExternalObjectSpec_cxx {
  /**
   ...
   */
  public override class func fromUnsafe(_ pointer: UnsafeMutableRawPointer) -> HybridExternalChildSpec_cxx {
