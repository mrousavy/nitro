...
extension HybridTestView {
  static func measureContent<Props, LayoutContext, LayoutConstraints, Size>(
    props: Props,
    layoutContext: LayoutContext,
    layoutConstraints: LayoutConstraints
  ) -> Size {
    fatalError("HybridTestView cannot be measured because it does not implement the generated measureContent(props:layoutContext:layoutConstraints:) signature.")
  }
}

/// Generated trampoline bridging the C++ ShadowNode's `measureContent` to
/// HybridTestView's `MeasurableView.measureContent(...)`. Do not call directly.
///
/// All four boundary types are Nitro structs, so each crosses the Swift<->C++
/// boundary as a single value.
public final class HybridTestViewMeasurer {
  ...
  private static let isMeasurableView: Bool = HybridTestView.self is any MeasurableView.Type
  ...
  public static func measure(props: TestViewProps,
                             layoutContext: LayoutContext,
                             layoutConstraints: LayoutConstraints) -> Size {
    return HybridTestView.measureContent(
      props: props,
      layoutContext: layoutContext,
      layoutConstraints: layoutConstraints
    )
