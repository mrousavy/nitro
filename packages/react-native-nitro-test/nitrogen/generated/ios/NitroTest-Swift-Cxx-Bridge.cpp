...
#include "HybridExternalSubclassSpecSwift.hpp"
...
namespace margelo::nitro::test::bridge::swift {
  ...
  std::shared_ptr<HybridExternalSubclassSpec> create_std__shared_ptr_HybridExternalSubclassSpec_(void* NON_NULL swiftUnsafePointer) noexcept {
    NitroTest::HybridExternalSubclassSpec_cxx swiftPart = NitroTest::HybridExternalSubclassSpec_cxx::fromUnsafe(swiftUnsafePointer);
    return std::make_shared<margelo::nitro::test::HybridExternalSubclassSpecSwift>(swiftPart);
  }
  void* NON_NULL get_std__shared_ptr_HybridExternalSubclassSpec_(std__shared_ptr_HybridExternalSubclassSpec_ cppType) {
    std::shared_ptr<margelo::nitro::test::HybridExternalSubclassSpecSwift> swiftWrapper = std::dynamic_pointer_cast<margelo::nitro::test::HybridExternalSubclassSpecSwift>(cppType);
    #ifdef NITRO_DEBUG
    if (swiftWrapper == nullptr) [[unlikely]] {
      throw std::runtime_error("Class \"HybridExternalSubclassSpec\" is not implemented in Swift!");
    }
    #endif
    NitroTest::HybridExternalSubclassSpec_cxx& swiftPart = swiftWrapper->getSwiftPart();
    return swiftPart.toUnsafe();
  }
