...
public final class NitroTestAutolinking {
   ...
   */
  public static func createViewWithChildren() -> bridge.std__shared_ptr_HybridViewWithChildrenSpec_ {
    let hybridObject = HybridViewWithChildren()
    return { () -> bridge.std__shared_ptr_HybridViewWithChildrenSpec_ in
      let __cxxWrapped = hybridObject.getCxxWrapper()
      return __cxxWrapped.getCxxPart()
    }()
  }
