...
public final class NitroTestAutolinking {
  ...
  /**
   * Creates an instance of a Swift class that implements `HybridAnyMapBenchmarkSpec`,
   * and wraps it in a Swift class that can directly interop with C++ (`HybridAnyMapBenchmarkSpec_cxx`)
   *
   * This is generated by Nitrogen and will initialize the class specified
   * in the `"autolinking"` property of `nitro.json` (in this case, `HybridAnyMapBenchmark`).
   */
  public static func createAnyMapBenchmark() -> bridge.std__shared_ptr_HybridAnyMapBenchmarkSpec_ {
    let hybridObject = HybridAnyMapBenchmark()
    return { () -> bridge.std__shared_ptr_HybridAnyMapBenchmarkSpec_ in
      let __cxxWrapped = hybridObject.getCxxWrapper()
      return __cxxWrapped.getCxxPart()
    }()
  }
