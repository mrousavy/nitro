...
public final class NitroTestAutolinking {
  ...
  /**
   * Creates an instance of a Swift class that implements `HybridExternalSubclassSpec`,
   * and wraps it in a Swift class that can directly interop with C++ (`HybridExternalSubclassSpec_cxx`)
   *
   * This is generated by Nitrogen and will initialize the class specified
   * in the `"autolinking"` property of `nitro.json` (in this case, `HybridExternalSubclass`).
   */
  public static func createExternalSubclass() -> bridge.std__shared_ptr_HybridExternalSubclassSpec_ {
    let hybridObject = HybridExternalSubclass()
    return { () -> bridge.std__shared_ptr_HybridExternalSubclassSpec_ in
      let __cxxWrapped = hybridObject.getCxxWrapper()
      return __cxxWrapped.getCxxPart()
    }()
  }
