...
public final class NitroTestAutolinking {
   ...
   */
  public static func createTestObjectSwiftKotlin() -> bridge.std__shared_ptr_margelo__nitro__test__HybridTestObjectSwiftKotlinSpec_ {
   ...
   */
  public static func createBase() -> bridge.std__shared_ptr_margelo__nitro__test__HybridBaseSpec_ {
   ...
   */
  public static func createChild() -> bridge.std__shared_ptr_margelo__nitro__test__HybridChildSpec_ {
   ...
   */
  public static func createTestView() -> bridge.std__shared_ptr_margelo__nitro__test__HybridTestViewSpec_ {
