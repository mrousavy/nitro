...
public final class NitroTestAutolinking {
  ...
  /**
   * Creates an instance of a Swift class that implements `HybridSomeExternalObjectSubclassSpec`,
   * and wraps it in a Swift class that can directly interop with C++ (`HybridSomeExternalObjectSubclassSpec_cxx`)
   *
   * This is generated by Nitrogen and will initialize the class specified
   * in the `"autolinking"` property of `nitro.json` (in this case, `HybridSomeExternalObjectSubclass`).
   */
  public static func createSomeExternalObjectSubclass() -> bridge.std__shared_ptr_HybridSomeExternalObjectSubclassSpec_ {
    let hybridObject = HybridSomeExternalObjectSubclass()
    return { () -> bridge.std__shared_ptr_HybridSomeExternalObjectSubclassSpec_ in
      return hybridObject.getCxxPart()
    }()
  }
