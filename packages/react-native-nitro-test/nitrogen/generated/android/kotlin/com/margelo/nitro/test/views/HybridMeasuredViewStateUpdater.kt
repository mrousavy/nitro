///
/// HybridMeasuredViewStateUpdater.kt
...
internal class HybridMeasuredViewStateUpdater {
  companion object {
    /**
    ...
    @JvmStatic
    external fun updateViewProps(view: HybridMeasuredViewSpec, state: StateWrapper)
  }
}
