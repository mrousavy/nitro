...
/**
 * Bridges the C++ ShadowNode's `measureContent` to HybridMeasuredView's
 * `MeasurableView<MeasuredViewProps>` companion. Do not call directly.
 */
@DoNotStrip
object HybridMeasuredViewMeasurer {
  ...
  // a typed, direct virtual call (the `<MeasuredViewProps>` generic is what keeps
  // it reflection-free).
  @Suppress("UNCHECKED_CAST")
  private val measurer: MeasurableView<MeasuredViewProps>? = run {
    try {
      val field = HybridMeasuredView::class.java.getDeclaredField("Companion")
      field.isAccessible = true
      field.get(null) as? MeasurableView<MeasuredViewProps>
  ...
  @JvmStatic
  @DoNotStrip
  fun measure(props: MeasuredViewProps,
    ...
    val m = measurer ?: error("HybridMeasuredView must expose companion object : MeasurableView<MeasuredViewProps> before HybridMeasuredViewMeasurer.measure is called.")
