...
/**
 * Represents the React Native `ViewManager` for the "MeasuredView" Nitro HybridView.
 */
public class HybridMeasuredViewManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridMeasuredView::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridMeasuredView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridMeasuredViewStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): HybridMeasuredView? {
    return view.getTag(associated_hybrid_view_tag) as? HybridMeasuredView
  }
}
