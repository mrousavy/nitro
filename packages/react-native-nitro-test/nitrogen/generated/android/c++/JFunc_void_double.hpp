...
namespace margelo::nitro::test {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/test/Func_void_double;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/test/Func_void_double_cxx;";
