...
namespace margelo::nitro::test {
  ...
  std::shared_ptr<HybridTestObjectSwiftKotlinSpec> JHybridTestObjectSwiftKotlinSpec::getThisObject() {
    ...
    return __result->getCppPart();
  }
  std::optional<std::shared_ptr<HybridTestObjectSwiftKotlinSpec>> JHybridTestObjectSwiftKotlinSpec::getOptionalHybrid() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JHybridTestObjectSwiftKotlinSpec::JavaPart>()>("getOptionalHybrid");
    auto __result = method(_javaPart);
    return __result != nullptr ? std::make_optional(__result->getCppPart()) : std::nullopt;
  }
  void JHybridTestObjectSwiftKotlinSpec::setOptionalHybrid(const std::optional<std::shared_ptr<HybridTestObjectSwiftKotlinSpec>>& optionalHybrid) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<JHybridTestObjectSwiftKotlinSpec::JavaPart> /* optionalHybrid */)>("setOptionalHybrid");
  ...
  double JHybridTestObjectSwiftKotlinSpec::getNumberValue() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<double()>("getNumberValue");
    auto __result = method(_javaPart);
    return __result;
  }
  void JHybridTestObjectSwiftKotlinSpec::setNumberValue(double numberValue) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(double /* numberValue */)>("setNumberValue");
    method(_javaPart, numberValue);
  }
  bool JHybridTestObjectSwiftKotlinSpec::getBoolValue() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jboolean()>("getBoolValue");
    auto __result = method(_javaPart);
    return static_cast<bool>(__result);
  }
  void JHybridTestObjectSwiftKotlinSpec::setBoolValue(bool boolValue) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jboolean /* boolValue */)>("setBoolValue");
    method(_javaPart, boolValue);
  }
  std::string JHybridTestObjectSwiftKotlinSpec::getStringValue() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JString>()>("getStringValue");
    auto __result = method(_javaPart);
    return __result->toStdString();
  }
  void JHybridTestObjectSwiftKotlinSpec::setStringValue(const std::string& stringValue) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<jni::JString> /* stringValue */)>("setStringValue");
    method(_javaPart, jni::make_jstring(stringValue));
  }
  int64_t JHybridTestObjectSwiftKotlinSpec::getInt64Value() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<int64_t()>("getInt64Value");
    auto __result = method(_javaPart);
    return __result;
  }
  void JHybridTestObjectSwiftKotlinSpec::setInt64Value(int64_t int64Value) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(int64_t /* int64Value */)>("setInt64Value");
    method(_javaPart, int64Value);
  }
  uint64_t JHybridTestObjectSwiftKotlinSpec::getUint64Value() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jlong()>("getUint64Value_cxx");
    auto __result = method(_javaPart);
    return static_cast<uint64_t>(__result);
  }
  void JHybridTestObjectSwiftKotlinSpec::setUint64Value(uint64_t uint64Value) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jlong /* uint64Value */)>("setUint64Value_cxx");
    method(_javaPart, uint64Value);
  }
  nitro::NullType JHybridTestObjectSwiftKotlinSpec::getNullValue() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JNull>()>("getNullValue");
    auto __result = method(_javaPart);
    return nitro::null;
  }
  void JHybridTestObjectSwiftKotlinSpec::setNullValue(nitro::NullType nullValue) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<JNull> /* nullValue */)>("setNullValue");
    method(_javaPart, JNull::null());
  }
  std::optional<std::string> JHybridTestObjectSwiftKotlinSpec::getOptionalString() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JString>()>("getOptionalString");
    auto __result = method(_javaPart);
    return __result != nullptr ? std::make_optional(__result->toStdString()) : std::nullopt;
  }
  void JHybridTestObjectSwiftKotlinSpec::setOptionalString(const std::optional<std::string>& optionalString) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<jni::JString> /* optionalString */)>("setOptionalString");
  ...
  std::optional<std::string> JHybridTestObjectSwiftKotlinSpec::getStringOrUndefined() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JString>()>("getStringOrUndefined");
    auto __result = method(_javaPart);
    return __result != nullptr ? std::make_optional(__result->toStdString()) : std::nullopt;
  }
  void JHybridTestObjectSwiftKotlinSpec::setStringOrUndefined(const std::optional<std::string>& stringOrUndefined) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<jni::JString> /* stringOrUndefined */)>("setStringOrUndefined");
  ...
  std::variant<nitro::NullType, std::string> JHybridTestObjectSwiftKotlinSpec::getStringOrNull() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JVariant_NullType_String>()>("getStringOrNull");
    auto __result = method(_javaPart);
    return __result->toCpp();
  }
  void JHybridTestObjectSwiftKotlinSpec::setStringOrNull(const std::variant<nitro::NullType, std::string>& stringOrNull) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<JVariant_NullType_String> /* stringOrNull */)>("setStringOrNull");
  ...
  std::optional<std::vector<std::string>> JHybridTestObjectSwiftKotlinSpec::getOptionalArray() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<jni::JString>>()>("getOptionalArray");
    auto __result = method(_javaPart);
  ...
  void JHybridTestObjectSwiftKotlinSpec::setOptionalArray(const std::optional<std::vector<std::string>>& optionalArray) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<jni::JArrayClass<jni::JString>> /* optionalArray */)>("setOptionalArray");
  ...
  std::optional<Powertrain> JHybridTestObjectSwiftKotlinSpec::getOptionalEnum() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPowertrain>()>("getOptionalEnum");
    auto __result = method(_javaPart);
    return __result != nullptr ? std::make_optional(__result->toCpp()) : std::nullopt;
  }
  void JHybridTestObjectSwiftKotlinSpec::setOptionalEnum(std::optional<Powertrain> optionalEnum) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<JPowertrain> /* optionalEnum */)>("setOptionalEnum");
  ...
  std::optional<OldEnum> JHybridTestObjectSwiftKotlinSpec::getOptionalOldEnum() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JOldEnum>()>("getOptionalOldEnum");
    auto __result = method(_javaPart);
    return __result != nullptr ? std::make_optional(__result->toCpp()) : std::nullopt;
  }
  void JHybridTestObjectSwiftKotlinSpec::setOptionalOldEnum(std::optional<OldEnum> optionalOldEnum) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<JOldEnum> /* optionalOldEnum */)>("setOptionalOldEnum");
  ...
  std::optional<std::function<void(double /* value */)>> JHybridTestObjectSwiftKotlinSpec::getOptionalCallback() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JFunc_void_double::javaobject>()>("getOptionalCallback_cxx");
    auto __result = method(_javaPart);
  ...
  void JHybridTestObjectSwiftKotlinSpec::setOptionalCallback(const std::optional<std::function<void(double /* value */)>>& optionalCallback) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<JFunc_void_double::javaobject> /* optionalCallback */)>("setOptionalCallback_cxx");
  ...
  bool JHybridTestObjectSwiftKotlinSpec::getHasBoolean() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jboolean()>("getHasBoolean");
    auto __result = method(_javaPart);
    return static_cast<bool>(__result);
  }
  bool JHybridTestObjectSwiftKotlinSpec::getIsBoolean() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jboolean()>("isBoolean");
    auto __result = method(_javaPart);
    return static_cast<bool>(__result);
  }
  bool JHybridTestObjectSwiftKotlinSpec::getHasBooleanWritable() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jboolean()>("getHasBooleanWritable");
    auto __result = method(_javaPart);
    return static_cast<bool>(__result);
  }
  void JHybridTestObjectSwiftKotlinSpec::setHasBooleanWritable(bool hasBooleanWritable) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jboolean /* hasBooleanWritable */)>("setHasBooleanWritable");
    method(_javaPart, hasBooleanWritable);
  }
  bool JHybridTestObjectSwiftKotlinSpec::getIsBooleanWritable() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jboolean()>("isBooleanWritable");
    auto __result = method(_javaPart);
    return static_cast<bool>(__result);
  }
  void JHybridTestObjectSwiftKotlinSpec::setIsBooleanWritable(bool isBooleanWritable) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jboolean /* isBooleanWritable */)>("setBooleanWritable");
    method(_javaPart, isBooleanWritable);
  }
  std::variant<std::string, double> JHybridTestObjectSwiftKotlinSpec::getSomeVariant() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JVariant_String_Double>()>("getSomeVariant");
    auto __result = method(_javaPart);
    return __result->toCpp();
  }
  void JHybridTestObjectSwiftKotlinSpec::setSomeVariant(const std::variant<std::string, double>& someVariant) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<JVariant_String_Double> /* someVariant */)>("setSomeVariant");
  ...
  std::shared_ptr<HybridTestObjectSwiftKotlinSpec> JHybridTestObjectSwiftKotlinSpec::newTestObject() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JHybridTestObjectSwiftKotlinSpec::JavaPart>()>("newTestObject");
    auto __result = method(_javaPart);
    return __result->getCppPart();
  }
  std::variant<std::shared_ptr<HybridTestObjectSwiftKotlinSpec>, Person> JHybridTestObjectSwiftKotlinSpec::getVariantHybrid(const std::variant<std::shared_ptr<HybridTestObjectSwiftKotlinSpec>, Person>& variant) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JVariant_HybridTestObjectSwiftKotlinSpec_Person>(jni::alias_ref<JVariant_HybridTestObjectSwiftKotlinSpec_Person> /* variant */)>("getVariantHybrid");
  ...
  void JHybridTestObjectSwiftKotlinSpec::simpleFunc() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void()>("simpleFunc");
    method(_javaPart);
  }
  double JHybridTestObjectSwiftKotlinSpec::addNumbers(double a, double b) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<double(double /* a */, double /* b */)>("addNumbers");
  ...
  std::string JHybridTestObjectSwiftKotlinSpec::addStrings(const std::string& a, const std::string& b) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JString>(jni::alias_ref<jni::JString> /* a */, jni::alias_ref<jni::JString> /* b */)>("addStrings");
  ...
  void JHybridTestObjectSwiftKotlinSpec::multipleArguments(double num, const std::string& str, bool boo) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(double /* num */, jni::alias_ref<jni::JString> /* str */, jboolean /* boo */)>("multipleArguments");
  ...
  nitro::NullType JHybridTestObjectSwiftKotlinSpec::bounceNull(nitro::NullType value) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JNull>(jni::alias_ref<JNull> /* value */)>("bounceNull");
  ...
  std::vector<std::string> JHybridTestObjectSwiftKotlinSpec::bounceStrings(const std::vector<std::string>& array) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<jni::JString>>(jni::alias_ref<jni::JArrayClass<jni::JString>> /* array */)>("bounceStrings");
    auto __result = method(_javaPart, [&]() {
  ...
  std::vector<double> JHybridTestObjectSwiftKotlinSpec::bounceNumbers(const std::vector<double>& array) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JArrayDouble>(jni::alias_ref<jni::JArrayDouble> /* array */)>("bounceNumbers");
    auto __result = method(_javaPart, [&]() {
      size_t __size = array.size();
  ...
  std::vector<Person> JHybridTestObjectSwiftKotlinSpec::bounceStructs(const std::vector<Person>& array) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<JPerson>>(jni::alias_ref<jni::JArrayClass<JPerson>> /* array */)>("bounceStructs");
    auto __result = method(_javaPart, [&]() {
      size_t __size = array.size();
  ...
  PartialPerson JHybridTestObjectSwiftKotlinSpec::bouncePartialStruct(const PartialPerson& person) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPartialPerson>(jni::alias_ref<JPartialPerson> /* person */)>("bouncePartialStruct");
  ...
  std::string JHybridTestObjectSwiftKotlinSpec::sumUpAllPassengers(const std::vector<Car>& cars) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JString>(jni::alias_ref<jni::JArrayClass<JCar>> /* cars */)>("sumUpAllPassengers");
    auto __result = method(_javaPart, [&]() {
  ...
  std::vector<Powertrain> JHybridTestObjectSwiftKotlinSpec::bounceEnums(const std::vector<Powertrain>& array) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<JPowertrain>>(jni::alias_ref<jni::JArrayClass<JPowertrain>> /* array */)>("bounceEnums");
    auto __result = method(_javaPart, [&]() {
      size_t __size = array.size();
  ...
  void JHybridTestObjectSwiftKotlinSpec::complexEnumCallback(const std::vector<Powertrain>& array, const std::function<void(const std::vector<Powertrain>& /* array */)>& callback) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<jni::JArrayClass<JPowertrain>> /* array */, jni::alias_ref<JFunc_void_std__vector_Powertrain_::javaobject> /* callback */)>("complexEnumCallback_cxx");
    method(_javaPart, [&]() {
      size_t __size = array.size();
      jni::local_ref<jni::JArrayClass<JPowertrain>> __array = jni::JArrayClass<JPowertrain>::newArray(__size);
      for (size_t __i = 0; __i < __size; __i++) {
  ...
  std::vector<std::shared_ptr<HybridChildSpec>> JHybridTestObjectSwiftKotlinSpec::bounceHybridObjects(const std::vector<std::shared_ptr<HybridChildSpec>>& array) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<JHybridChildSpec::JavaPart>>(jni::alias_ref<jni::JArrayClass<JHybridChildSpec::JavaPart>> /* array */)>("bounceHybridObjects");
    auto __result = method(_javaPart, [&]() {
      size_t __size = array.size();
    ...
    return [&]() {
      ...
      for (size_t __i = 0; __i < __size; __i++) {
        auto __element = __result->getElement(__i);
        __vector.push_back(__element->getCppPart());
      }
      return __vector;
    }();
  }
  std::vector<std::function<void()>> JHybridTestObjectSwiftKotlinSpec::bounceFunctions(const std::vector<std::function<void()>>& functions) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<JFunc_void::javaobject>>(jni::alias_ref<jni::JArrayClass<JFunc_void::javaobject>> /* functions */)>("bounceFunctions_cxx");
    auto __result = method(_javaPart, [&]() {
  ...
  std::vector<std::shared_ptr<AnyMap>> JHybridTestObjectSwiftKotlinSpec::bounceMaps(const std::vector<std::shared_ptr<AnyMap>>& maps) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<JAnyMap::javaobject>>(jni::alias_ref<jni::JArrayClass<JAnyMap::javaobject>> /* maps */)>("bounceMaps");
    auto __result = method(_javaPart, [&]() {
  ...
  std::vector<std::shared_ptr<Promise<double>>> JHybridTestObjectSwiftKotlinSpec::bouncePromises(const std::vector<std::shared_ptr<Promise<double>>>& promises) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<JPromise::javaobject>>(jni::alias_ref<jni::JArrayClass<JPromise::javaobject>> /* promises */)>("bouncePromises");
    auto __result = method(_javaPart, [&]() {
  ...
  std::vector<std::shared_ptr<ArrayBuffer>> JHybridTestObjectSwiftKotlinSpec::bounceArrayBuffers(const std::vector<std::shared_ptr<ArrayBuffer>>& arrayBuffers) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<JArrayBuffer::javaobject>>(jni::alias_ref<jni::JArrayClass<JArrayBuffer::javaobject>> /* arrayBuffers */)>("bounceArrayBuffers");
    auto __result = method(_javaPart, [&]() {
  ...
  std::shared_ptr<AnyMap> JHybridTestObjectSwiftKotlinSpec::createMap() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JAnyMap::javaobject>()>("createMap");
    auto __result = method(_javaPart);
  ...
  std::shared_ptr<AnyMap> JHybridTestObjectSwiftKotlinSpec::mapRoundtrip(const std::shared_ptr<AnyMap>& map) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JAnyMap::javaobject>(jni::alias_ref<JAnyMap::javaobject> /* map */)>("mapRoundtrip");
  ...
  std::vector<std::string> JHybridTestObjectSwiftKotlinSpec::getMapKeys(const std::shared_ptr<AnyMap>& map) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JArrayClass<jni::JString>>(jni::alias_ref<JAnyMap::javaobject> /* map */)>("getMapKeys");
    auto __result = method(_javaPart, JAnyMap::create(map));
    return [&]() {
      size_t __size = __result->size();
      std::vector<std::string> __vector;
  ...
  std::shared_ptr<AnyMap> JHybridTestObjectSwiftKotlinSpec::mergeMaps(const std::shared_ptr<AnyMap>& a, const std::shared_ptr<AnyMap>& b) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JAnyMap::javaobject>(jni::alias_ref<JAnyMap::javaobject> /* a */, jni::alias_ref<JAnyMap::javaobject> /* b */)>("mergeMaps");
  ...
  std::shared_ptr<AnyMap> JHybridTestObjectSwiftKotlinSpec::copyAnyMap(const std::shared_ptr<AnyMap>& map) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JAnyMap::javaobject>(jni::alias_ref<JAnyMap::javaobject> /* map */)>("copyAnyMap");
    auto __result = method(_javaPart, JAnyMap::create(map));
    return __result->cthis()->getMap();
  }
  std::unordered_map<std::string, std::variant<bool, double>> JHybridTestObjectSwiftKotlinSpec::bounceMap(const std::unordered_map<std::string, std::variant<bool, double>>& map) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JMap<jni::JString, JVariant_Boolean_Double>>(jni::alias_ref<jni::JMap<jni::JString, JVariant_Boolean_Double>> /* map */)>("bounceMap");
  ...
  std::unordered_map<std::string, double> JHybridTestObjectSwiftKotlinSpec::bounceSimpleMap(const std::unordered_map<std::string, double>& map) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JMap<jni::JString, jni::JDouble>>(jni::alias_ref<jni::JMap<jni::JString, jni::JDouble>> /* map */)>("bounceSimpleMap");
  ...
  std::unordered_map<std::string, std::string> JHybridTestObjectSwiftKotlinSpec::extractMap(const MapWrapper& mapWrapper) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JMap<jni::JString, jni::JString>>(jni::alias_ref<JMapWrapper> /* mapWrapper */)>("extractMap");
  ...
  double JHybridTestObjectSwiftKotlinSpec::funcThatThrows() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<double()>("funcThatThrows");
    auto __result = method(_javaPart);
    return __result;
  }
  std::shared_ptr<Promise<void>> JHybridTestObjectSwiftKotlinSpec::funcThatThrowsBeforePromise() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("funcThatThrowsBeforePromise");
    auto __result = method(_javaPart);
    return [&]() {
  ...
  void JHybridTestObjectSwiftKotlinSpec::throwError(const std::exception_ptr& error) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<jni::JThrowable> /* error */)>("throwError");
  ...
  std::string JHybridTestObjectSwiftKotlinSpec::tryOptionalParams(double num, bool boo, const std::optional<std::string>& str) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JString>(double /* num */, jboolean /* boo */, jni::alias_ref<jni::JString> /* str */)>("tryOptionalParams");
  ...
  std::string JHybridTestObjectSwiftKotlinSpec::tryMiddleParam(double num, std::optional<bool> boo, const std::string& str) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<jni::JString>(double /* num */, jni::alias_ref<jni::JBoolean> /* boo */, jni::alias_ref<jni::JString> /* str */)>("tryMiddleParam");
  ...
  std::optional<Powertrain> JHybridTestObjectSwiftKotlinSpec::tryOptionalEnum(std::optional<Powertrain> value) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPowertrain>(jni::alias_ref<JPowertrain> /* value */)>("tryOptionalEnum");
  ...
  bool JHybridTestObjectSwiftKotlinSpec::tryTrailingOptional(double num, const std::string& str, std::optional<bool> boo) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jboolean(double /* num */, jni::alias_ref<jni::JString> /* str */, jni::alias_ref<jni::JBoolean> /* boo */)>("tryTrailingOptional");
  ...
  std::chrono::system_clock::time_point JHybridTestObjectSwiftKotlinSpec::add1Hour(std::chrono::system_clock::time_point date) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JInstant>(jni::alias_ref<JInstant> /* date */)>("add1Hour");
  ...
  std::chrono::system_clock::time_point JHybridTestObjectSwiftKotlinSpec::currentDate() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JInstant>()>("currentDate");
    auto __result = method(_javaPart);
    return __result->toChrono();
  }
  int64_t JHybridTestObjectSwiftKotlinSpec::calculateFibonacciSync(double value) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<int64_t(double /* value */)>("calculateFibonacciSync");
  ...
  std::shared_ptr<Promise<int64_t>> JHybridTestObjectSwiftKotlinSpec::calculateFibonacciAsync(double value) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(double /* value */)>("calculateFibonacciAsync");
    auto __result = method(_javaPart, value);
    return [&]() {
  ...
  std::shared_ptr<Promise<void>> JHybridTestObjectSwiftKotlinSpec::wait(double seconds) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(double /* seconds */)>("wait");
  ...
  std::shared_ptr<Promise<void>> JHybridTestObjectSwiftKotlinSpec::promiseThrows() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("promiseThrows");
    auto __result = method(_javaPart);
    return [&]() {
      auto __promise = Promise<void>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& /* unit */) {
  ...
  std::shared_ptr<Promise<double>> JHybridTestObjectSwiftKotlinSpec::promiseReturnsInstantly() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("promiseReturnsInstantly");
    auto __result = method(_javaPart);
    return [&]() {
      auto __promise = Promise<double>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
  ...
  std::shared_ptr<Promise<double>> JHybridTestObjectSwiftKotlinSpec::promiseReturnsInstantlyAsync() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("promiseReturnsInstantlyAsync");
    auto __result = method(_javaPart);
    return [&]() {
      auto __promise = Promise<double>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
  ...
  std::shared_ptr<Promise<void>> JHybridTestObjectSwiftKotlinSpec::promiseThatResolvesVoidInstantly() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("promiseThatResolvesVoidInstantly");
    auto __result = method(_javaPart);
    return [&]() {
      auto __promise = Promise<void>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& /* unit */) {
  ...
  std::shared_ptr<Promise<std::optional<double>>> JHybridTestObjectSwiftKotlinSpec::promiseThatResolvesToUndefined() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("promiseThatResolvesToUndefined");
    auto __result = method(_javaPart);
    return [&]() {
  ...
  std::shared_ptr<Promise<double>> JHybridTestObjectSwiftKotlinSpec::awaitAndGetPromise(const std::shared_ptr<Promise<double>>& promise) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<JPromise::javaobject> /* promise */)>("awaitAndGetPromise");
    auto __result = method(_javaPart, [&]() {
      jni::local_ref<JPromise::javaobject> __localPromise = JPromise::create();
      jni::global_ref<JPromise::javaobject> __promise = jni::make_global(__localPromise);
  ...
  std::shared_ptr<Promise<Car>> JHybridTestObjectSwiftKotlinSpec::awaitAndGetComplexPromise(const std::shared_ptr<Promise<Car>>& promise) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<JPromise::javaobject> /* promise */)>("awaitAndGetComplexPromise");
    auto __result = method(_javaPart, [&]() {
      jni::local_ref<JPromise::javaobject> __localPromise = JPromise::create();
      jni::global_ref<JPromise::javaobject> __promise = jni::make_global(__localPromise);
  ...
  std::shared_ptr<Promise<void>> JHybridTestObjectSwiftKotlinSpec::awaitPromise(const std::shared_ptr<Promise<void>>& promise) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<JPromise::javaobject> /* promise */)>("awaitPromise");
    auto __result = method(_javaPart, [&]() {
      jni::local_ref<JPromise::javaobject> __localPromise = JPromise::create();
      jni::global_ref<JPromise::javaobject> __promise = jni::make_global(__localPromise);
  ...
  void JHybridTestObjectSwiftKotlinSpec::callCallback(const std::function<void()>& callback) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<JFunc_void::javaobject> /* callback */)>("callCallback_cxx");
  ...
  std::shared_ptr<Promise<void>> JHybridTestObjectSwiftKotlinSpec::callCallbackThatReturnsPromiseVoid(const std::function<std::shared_ptr<Promise<std::shared_ptr<Promise<void>>>>()>& callback) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<JFunc_std__shared_ptr_Promise_std__shared_ptr_Promise_void____::javaobject> /* callback */)>("callCallbackThatReturnsPromiseVoid_cxx");
  ...
  void JHybridTestObjectSwiftKotlinSpec::callAll(const std::function<void()>& first, const std::function<void()>& second, const std::function<void()>& third) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<JFunc_void::javaobject> /* first */, jni::alias_ref<JFunc_void::javaobject> /* second */, jni::alias_ref<JFunc_void::javaobject> /* third */)>("callAll_cxx");
  ...
  void JHybridTestObjectSwiftKotlinSpec::callWithOptional(std::optional<double> value, const std::function<void(std::optional<double> /* maybe */)>& callback) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<jni::JDouble> /* value */, jni::alias_ref<JFunc_void_std__optional_double_::javaobject> /* callback */)>("callWithOptional_cxx");
  ...
  std::shared_ptr<Promise<double>> JHybridTestObjectSwiftKotlinSpec::callSumUpNTimes(const std::function<std::shared_ptr<Promise<double>>()>& callback, double n) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<JFunc_std__shared_ptr_Promise_double__::javaobject> /* callback */, double /* n */)>("callSumUpNTimes_cxx");
  ...
  std::shared_ptr<Promise<double>> JHybridTestObjectSwiftKotlinSpec::callbackAsyncPromise(const std::function<std::shared_ptr<Promise<std::shared_ptr<Promise<double>>>>()>& callback) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<JFunc_std__shared_ptr_Promise_std__shared_ptr_Promise_double____::javaobject> /* callback */)>("callbackAsyncPromise_cxx");
  ...
  std::shared_ptr<Promise<std::shared_ptr<ArrayBuffer>>> JHybridTestObjectSwiftKotlinSpec::callbackAsyncPromiseBuffer(const std::function<std::shared_ptr<Promise<std::shared_ptr<Promise<std::shared_ptr<ArrayBuffer>>>>>()>& callback) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<JFunc_std__shared_ptr_Promise_std__shared_ptr_Promise_std__shared_ptr_ArrayBuffer_____::javaobject> /* callback */)>("callbackAsyncPromiseBuffer_cxx");
  ...
  std::function<void(double /* value */)> JHybridTestObjectSwiftKotlinSpec::getComplexCallback() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JFunc_void_double::javaobject>()>("getComplexCallback_cxx");
    auto __result = method(_javaPart);
  ...
  void JHybridTestObjectSwiftKotlinSpec::twoOptionalCallbacks(double value, const std::optional<std::function<void(double /* value */)>>& first, const std::optional<std::function<void(const std::string& /* value */)>>& second) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(double /* value */, jni::alias_ref<JFunc_void_double::javaobject> /* first */, jni::alias_ref<JFunc_void_std__string::javaobject> /* second */)>("twoOptionalCallbacks_cxx");
  ...
  void JHybridTestObjectSwiftKotlinSpec::errorCallback(const std::function<void(const std::exception_ptr& /* error */)>& onError) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<JFunc_void_std__exception_ptr::javaobject> /* onError */)>("errorCallback_cxx");
  ...
  std::function<void(double /* num */)> JHybridTestObjectSwiftKotlinSpec::createNativeCallback(const std::function<void(double /* num */)>& wrappingJsCallback) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JFunc_void_double::javaobject>(jni::alias_ref<JFunc_void_double::javaobject> /* wrappingJsCallback */)>("createNativeCallback_cxx");
  ...
  std::shared_ptr<Promise<double>> JHybridTestObjectSwiftKotlinSpec::getValueFromJSCallbackAndWait(const std::function<std::shared_ptr<Promise<double>>()>& getValue) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<JFunc_std__shared_ptr_Promise_double__::javaobject> /* getValue */)>("getValueFromJSCallbackAndWait_cxx");
  ...
  std::shared_ptr<Promise<void>> JHybridTestObjectSwiftKotlinSpec::getValueFromJsCallback(const std::function<std::shared_ptr<Promise<std::string>>()>& callback, const std::function<void(const std::string& /* valueFromJs */)>& andThenCall) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>(jni::alias_ref<JFunc_std__shared_ptr_Promise_std__string__::javaobject> /* callback */, jni::alias_ref<JFunc_void_std__string::javaobject> /* andThenCall */)>("getValueFromJsCallback_cxx");
  ...
  Car JHybridTestObjectSwiftKotlinSpec::getCar() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JCar>()>("getCar");
    auto __result = method(_javaPart);
    return __result->toCpp();
  }
  bool JHybridTestObjectSwiftKotlinSpec::isCarElectric(const Car& car) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jboolean(jni::alias_ref<JCar> /* car */)>("isCarElectric");
  ...
  std::optional<Person> JHybridTestObjectSwiftKotlinSpec::getDriver(const Car& car) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPerson>(jni::alias_ref<JCar> /* car */)>("getDriver");
    auto __result = method(_javaPart, JCar::fromCpp(car));
    return __result != nullptr ? std::make_optional(__result->toCpp()) : std::nullopt;
  }
  Car JHybridTestObjectSwiftKotlinSpec::bounceCar(const Car& car) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JCar>(jni::alias_ref<JCar> /* car */)>("bounceCar");
    auto __result = method(_javaPart, JCar::fromCpp(car));
    return __result->toCpp();
  }
  void JHybridTestObjectSwiftKotlinSpec::jsStyleObjectAsParameters(const JsStyleStruct& params) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<JJsStyleStruct> /* params */)>("jsStyleObjectAsParameters");
  ...
  WrappedJsStruct JHybridTestObjectSwiftKotlinSpec::bounceWrappedJsStyleStruct(const WrappedJsStruct& value) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JWrappedJsStruct>(jni::alias_ref<JWrappedJsStruct> /* value */)>("bounceWrappedJsStyleStruct");
  ...
  OptionalWrapper JHybridTestObjectSwiftKotlinSpec::bounceOptionalWrapper(const OptionalWrapper& wrapper) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JOptionalWrapper>(jni::alias_ref<JOptionalWrapper> /* wrapper */)>("bounceOptionalWrapper");
  ...
  OptionalCallback JHybridTestObjectSwiftKotlinSpec::bounceOptionalCallback(const OptionalCallback& value) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JOptionalCallback>(jni::alias_ref<JOptionalCallback> /* value */)>("bounceOptionalCallback");
  ...
  std::shared_ptr<ArrayBuffer> JHybridTestObjectSwiftKotlinSpec::createArrayBuffer() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JArrayBuffer::javaobject>()>("createArrayBuffer");
    auto __result = method(_javaPart);
  ...
  std::shared_ptr<ArrayBuffer> JHybridTestObjectSwiftKotlinSpec::createArrayBufferFromNativeBuffer(bool copy) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JArrayBuffer::javaobject>(jboolean /* copy */)>("createArrayBufferFromNativeBuffer");
  ...
  std::shared_ptr<ArrayBuffer> JHybridTestObjectSwiftKotlinSpec::copyBuffer(const std::shared_ptr<ArrayBuffer>& buffer) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JArrayBuffer::javaobject>(jni::alias_ref<JArrayBuffer::javaobject> /* buffer */)>("copyBuffer");
  ...
  double JHybridTestObjectSwiftKotlinSpec::getBufferLastItem(const std::shared_ptr<ArrayBuffer>& buffer) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<double(jni::alias_ref<JArrayBuffer::javaobject> /* buffer */)>("getBufferLastItem");
    auto __result = method(_javaPart, JArrayBuffer::wrap(buffer));
    return __result;
  }
  void JHybridTestObjectSwiftKotlinSpec::setAllValuesTo(const std::shared_ptr<ArrayBuffer>& buffer, double value) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<void(jni::alias_ref<JArrayBuffer::javaobject> /* buffer */, double /* value */)>("setAllValuesTo");
  ...
  std::shared_ptr<Promise<std::shared_ptr<ArrayBuffer>>> JHybridTestObjectSwiftKotlinSpec::createArrayBufferAsync() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("createArrayBufferAsync");
    auto __result = method(_javaPart);
    return [&]() {
      auto __promise = Promise<std::shared_ptr<ArrayBuffer>>::create();
      __result->cthis()->addOnResolvedListener([=](const jni::alias_ref<jni::JObject>& __boxedResult) {
  ...
  std::shared_ptr<ArrayBuffer> JHybridTestObjectSwiftKotlinSpec::bounceArrayBuffer(const std::shared_ptr<ArrayBuffer>& buffer) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JArrayBuffer::javaobject>(jni::alias_ref<JArrayBuffer::javaobject> /* buffer */)>("bounceArrayBuffer");
    auto __result = method(_javaPart, JArrayBuffer::wrap(buffer));
    return __result->cthis()->getArrayBuffer();
  }
  std::variant<std::string, double> JHybridTestObjectSwiftKotlinSpec::passVariant(const std::variant<bool, std::vector<double>, std::vector<std::string>, std::string, double>& either) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JVariant_String_Double>(jni::alias_ref<JVariant_Boolean_DoubleArray_Array_String__String_Double> /* either */)>("passVariant");
  ...
  std::variant<bool, OldEnum> JHybridTestObjectSwiftKotlinSpec::getVariantEnum(const std::variant<bool, OldEnum>& variant) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JVariant_Boolean_OldEnum>(jni::alias_ref<JVariant_Boolean_OldEnum> /* variant */)>("getVariantEnum");
  ...
  std::variant<bool, WeirdNumbersEnum> JHybridTestObjectSwiftKotlinSpec::getVariantWeirdNumbersEnum(const std::variant<bool, WeirdNumbersEnum>& variant) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JVariant_Boolean_WeirdNumbersEnum>(jni::alias_ref<JVariant_Boolean_WeirdNumbersEnum> /* variant */)>("getVariantWeirdNumbersEnum");
  ...
  std::variant<Car, Person> JHybridTestObjectSwiftKotlinSpec::getVariantObjects(const std::variant<Car, Person>& variant) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JVariant_Car_Person>(jni::alias_ref<JVariant_Car_Person> /* variant */)>("getVariantObjects");
  ...
  std::variant<std::string, Car> JHybridTestObjectSwiftKotlinSpec::passNamedVariant(const std::variant<std::string, Car>& variant) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JNamedVariant>(jni::alias_ref<JNamedVariant> /* variant */)>("passNamedVariant");
  ...
  std::variant<std::shared_ptr<HybridBaseSpec>, OptionalWrapper> JHybridTestObjectSwiftKotlinSpec::passAllEmptyObjectVariant(const std::variant<std::shared_ptr<HybridBaseSpec>, OptionalWrapper>& variant) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JVariant_HybridBaseSpec_OptionalWrapper>(jni::alias_ref<JVariant_HybridBaseSpec_OptionalWrapper> /* variant */)>("passAllEmptyObjectVariant");
  ...
  std::variant<std::shared_ptr<ArrayBuffer>, std::function<void(double /* value */)>, WrappedJsStruct, std::shared_ptr<Promise<double>>, std::chrono::system_clock::time_point, std::shared_ptr<AnyMap>> JHybridTestObjectSwiftKotlinSpec::bounceComplexVariant(const std::variant<std::shared_ptr<ArrayBuffer>, std::function<void(double /* value */)>, WrappedJsStruct, std::shared_ptr<Promise<double>>, std::chrono::system_clock::time_point, std::shared_ptr<AnyMap>>& variant) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JCoreTypesVariant>(jni::alias_ref<JCoreTypesVariant> /* variant */)>("bounceComplexVariant");
  ...
  std::shared_ptr<HybridChildSpec> JHybridTestObjectSwiftKotlinSpec::createChild() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JHybridChildSpec::JavaPart>()>("createChild");
    auto __result = method(_javaPart);
    return __result->getCppPart();
  }
  std::shared_ptr<HybridBaseSpec> JHybridTestObjectSwiftKotlinSpec::createBase() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JHybridBaseSpec::JavaPart>()>("createBase");
    auto __result = method(_javaPart);
    return __result->getCppPart();
  }
  std::shared_ptr<HybridBaseSpec> JHybridTestObjectSwiftKotlinSpec::createBaseActualChild() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JHybridBaseSpec::JavaPart>()>("createBaseActualChild");
    auto __result = method(_javaPart);
    return __result->getCppPart();
  }
  std::shared_ptr<HybridChildSpec> JHybridTestObjectSwiftKotlinSpec::bounceChild(const std::shared_ptr<HybridChildSpec>& child) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JHybridChildSpec::JavaPart>(jni::alias_ref<JHybridChildSpec::JavaPart> /* child */)>("bounceChild");
  ...
  std::shared_ptr<HybridBaseSpec> JHybridTestObjectSwiftKotlinSpec::bounceBase(const std::shared_ptr<HybridBaseSpec>& base) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JHybridBaseSpec::JavaPart>(jni::alias_ref<JHybridBaseSpec::JavaPart> /* base */)>("bounceBase");
  ...
  std::shared_ptr<HybridBaseSpec> JHybridTestObjectSwiftKotlinSpec::bounceChildBase(const std::shared_ptr<HybridChildSpec>& child) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JHybridBaseSpec::JavaPart>(jni::alias_ref<JHybridChildSpec::JavaPart> /* child */)>("bounceChildBase");
    auto __result = method(_javaPart, std::dynamic_pointer_cast<JHybridChildSpec>(child)->getJavaPart());
    return __result->getCppPart();
  }
  std::shared_ptr<HybridChildSpec> JHybridTestObjectSwiftKotlinSpec::castBase(const std::shared_ptr<HybridBaseSpec>& base) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JHybridChildSpec::JavaPart>(jni::alias_ref<JHybridBaseSpec::JavaPart> /* base */)>("castBase");
    auto __result = method(_javaPart, std::dynamic_pointer_cast<JHybridBaseSpec>(base)->getJavaPart());
    return __result->getCppPart();
  }
  double JHybridTestObjectSwiftKotlinSpec::callbackSync(const std::function<double()>& callback) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<double(jni::alias_ref<JFunc_double::javaobject> /* callback */)>("callbackSync_cxx");
  ...
  bool JHybridTestObjectSwiftKotlinSpec::getIsViewBlue(const std::shared_ptr<HybridTestViewSpec>& view) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jboolean(jni::alias_ref<JHybridTestViewSpec::JavaPart> /* view */)>("getIsViewBlue");
  ...
  std::shared_ptr<margelo::nitro::test::external::HybridSomeExternalObjectSpec> JHybridTestObjectSwiftKotlinSpec::bounceExternalHybrid(const std::shared_ptr<margelo::nitro::test::external::HybridSomeExternalObjectSpec>& externalObject) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<margelo::nitro::test::external::JHybridSomeExternalObjectSpec::JavaPart>(jni::alias_ref<margelo::nitro::test::external::JHybridSomeExternalObjectSpec::JavaPart> /* externalObject */)>("bounceExternalHybrid");
  ...
  std::shared_ptr<margelo::nitro::test::external::HybridSomeExternalObjectSpec> JHybridTestObjectSwiftKotlinSpec::createInternalObject() {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<margelo::nitro::test::external::JHybridSomeExternalObjectSpec::JavaPart>()>("createInternalObject");
    auto __result = method(_javaPart);
    return __result->getCppPart();
  }
  ExternalObjectStruct JHybridTestObjectSwiftKotlinSpec::bounceExternalStruct(const ExternalObjectStruct& externalStruct) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JExternalObjectStruct>(jni::alias_ref<JExternalObjectStruct> /* externalStruct */)>("bounceExternalStruct");
  ...
  std::variant<std::shared_ptr<margelo::nitro::test::external::HybridSomeExternalObjectSpec>, std::string> JHybridTestObjectSwiftKotlinSpec::bounceExternalVariant(const std::variant<std::shared_ptr<margelo::nitro::test::external::HybridSomeExternalObjectSpec>, std::string>& variant) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<JStringOrExternal>(jni::alias_ref<JStringOrExternal> /* variant */)>("bounceExternalVariant");
  ...
  std::shared_ptr<margelo::nitro::test::external::HybridSomeExternalObjectSpec> JHybridTestObjectSwiftKotlinSpec::createExternalVariantFromFunc(const std::function<std::shared_ptr<margelo::nitro::test::external::HybridSomeExternalObjectSpec>()>& factory) {
    static const auto method = JavaPart::javaClassStatic()->getMethod<jni::local_ref<margelo::nitro::test::external::JHybridSomeExternalObjectSpec::JavaPart>(jni::alias_ref<JFunc_std__shared_ptr_margelo__nitro__test__external__HybridSomeExternalObjectSpec_::javaobject> /* factory */)>("createExternalVariantFromFunc_cxx");
