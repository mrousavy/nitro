...
#include "JAdvancedPowertrain.hpp"
#include <functional>
...
namespace margelo::nitro::test {
  ...
  std::optional<AdvancedPowertrain> JHybridTestObjectSwiftKotlinSpec::getOptionalEnumPlusOne() {
    static const auto method = _javaPart->javaClassStatic()->getMethod<jni::local_ref<JAdvancedPowertrain>()>("getOptionalEnumPlusOne");
    auto __result = method(_javaPart);
    return __result != nullptr ? std::make_optional(__result->toCpp()) : std::nullopt;
  }
  void JHybridTestObjectSwiftKotlinSpec::setOptionalEnumPlusOne(std::optional<AdvancedPowertrain> optionalEnumPlusOne) {
    static const auto method = _javaPart->javaClassStatic()->getMethod<void(jni::alias_ref<JAdvancedPowertrain> /* optionalEnumPlusOne */)>("setOptionalEnumPlusOne");
    method(_javaPart, optionalEnumPlusOne.has_value() ? JAdvancedPowertrain::fromCpp(optionalEnumPlusOne.value()) : nullptr);
  }
