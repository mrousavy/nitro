...
namespace margelo::nitro::test {
  ...
  std::shared_ptr<HybridSomeExternalObjectSubclassSpec> JHybridTestObjectSwiftKotlinSpec::createExternalObjectInternalSubclass() {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JHybridSomeExternalObjectSubclassSpec::javaobject>()>("createExternalObjectInternalSubclass");
    auto __result = method(_javaPart);
