...
namespace margelo::nitro::test {
  ...
  std::shared_ptr<Promise<std::optional<double>>> JHybridTestObjectSwiftKotlinSpec::promiseWithUndefinedResult() {
    static const auto method = javaClassStatic()->getMethod<jni::local_ref<JPromise::javaobject>()>("promiseWithUndefinedResult");
    auto __result = method(_javaPart);
    return [&]() {
