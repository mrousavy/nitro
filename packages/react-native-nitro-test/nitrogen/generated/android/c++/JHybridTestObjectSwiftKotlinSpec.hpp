...
namespace margelo::nitro::test {
  ...
  public:
    ...
    [[maybe_unused]] nitro::NullType getNullValue() override;
    void setNullValue([[maybe_unused]] nitro::NullType nullValue) override;
    ...
    std::variant<[[maybe_unused]] nitro::NullType, std::string> getStringOrNull() override;
    void setStringOrNull(const std::variant<[[maybe_unused]] nitro::NullType, std::string>& stringOrNull) override;
  ...
  public:
    ...
    [[maybe_unused]] nitro::NullType bounceNull([[maybe_unused]] nitro::NullType value) override;
