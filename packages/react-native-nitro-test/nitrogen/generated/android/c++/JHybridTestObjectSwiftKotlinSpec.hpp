...
namespace margelo::nitro::test {
  ...
  public:
    ...
    std::shared_ptr<Promise<Car>> callbacksPutPersonInCar(const std::function<void(const Person& /* person */)>& first, const std::function<void(const Car& /* car */)>& second) override;
