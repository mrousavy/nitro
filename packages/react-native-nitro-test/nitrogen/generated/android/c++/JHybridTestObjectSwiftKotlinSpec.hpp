...
namespace margelo::nitro::test {
  ...
  public:
    // Java part for JHybridTestObjectSwiftKotlinSpec - this is the abstract Kotlin spec class.
  ...
  public:
    // C++ part for JHybridTestObjectSwiftKotlinSpec - this holds a weak_ptr to the C++ class to break the retain cycle.
    ...
    private:
      ...
      std::weak_ptr<JHybridTestObjectSwiftKotlinSpec> _cppPart;
    };

  public:
    // C++ constructor that wraps the Java Part
    explicit JHybridTestObjectSwiftKotlinSpec(const jni::local_ref<JavaPart>& javaPart) :
