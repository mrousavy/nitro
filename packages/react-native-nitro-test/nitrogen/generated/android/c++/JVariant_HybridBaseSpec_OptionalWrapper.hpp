...
namespace margelo::nitro::test {
  ...
  public:
    ...
    static jni::local_ref<JVariant_HybridBaseSpec_OptionalWrapper> create_0(jni::alias_ref<JHybridBaseSpec> value) {
      static const auto method = javaClassStatic()->getStaticMethod<JVariant_HybridBaseSpec_OptionalWrapper(jni::alias_ref<JHybridBaseSpec>)>("create");
  ...
  namespace JVariant_HybridBaseSpec_OptionalWrapper_impl {
    ...
    public:
      ...
      [[nodiscard]] jni::local_ref<JHybridBaseSpec> getValue() const {
        static const auto field = javaClassStatic()->getField<JHybridBaseSpec>("value");
