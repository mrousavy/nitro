...
namespace margelo::nitro::test {
  ...
  public:
    ...
    static jni::local_ref<JCoreTypesVariant> fromCpp(const std::variant<std::shared_ptr<ArrayBuffer>, std::function<void(double /* value */)>, WrappedJsStruct, std::shared_ptr<Promise<void>>, std::chrono::system_clock::time_point, std::shared_ptr<AnyMap>>& variant) {
      switch (variant.index()) {
        ...
        case 3: return create_3([&]() {
          ...
          std::get<3>(variant)->addOnResolvedListener([=]() {
    ...
    [[nodiscard]] std::variant<std::shared_ptr<ArrayBuffer>, std::function<void(double /* value */)>, WrappedJsStruct, std::shared_ptr<Promise<void>>, std::chrono::system_clock::time_point, std::shared_ptr<AnyMap>> toCpp() const;
  };
