...
namespace margelo::nitro::test {
  ...
  public:
    ...
    ExternalObjectStruct toCpp() const {
      ...
      static const auto fieldSomeExternal = clazz->getField<margelo::nitro::test::external::JHybridSomeExternalObjectSpec>("someExternal");
      jni::local_ref<margelo::nitro::test::external::JHybridSomeExternalObjectSpec> someExternal = this->getFieldValue(fieldSomeExternal);
  ...
  public:
    ...
    static jni::local_ref<JExternalObjectStruct::javaobject> fromCpp(const ExternalObjectStruct& value) {
      using JSignature = JExternalObjectStruct(jni::alias_ref<margelo::nitro::test::external::JHybridSomeExternalObjectSpec>);
      static const auto clazz = javaClassStatic();
