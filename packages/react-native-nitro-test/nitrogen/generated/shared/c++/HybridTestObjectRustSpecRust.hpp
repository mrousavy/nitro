...
extern "C" {
  ...
  void HybridTestObjectRustSpec_bounce_null(void* rustPtr);
  ...
  double HybridTestObjectRustSpec_get_value_from_js_callback_and_wait(void* rustPtr, void* getValue);
...
namespace margelo::nitro::test {
  ...
  public:
    ...
    inline std::optional<std::shared_ptr<HybridTestObjectRustSpec>> getOptionalHybrid() override { return [&]() -> std::optional<std::shared_ptr<HybridTestObjectRustSpec>> { struct __Opt { uint8_t has_value; void* value; }; auto __s = static_cast<__Opt*>(HybridTestObjectRustSpec_get_optional_hybrid(_rustPtr)); std::optional<std::shared_ptr<HybridTestObjectRustSpec>> __r; if (__s->has_value) { __r = __s->value; } delete __s; return __r; }(); }
    inline void setOptionalHybrid(const std::optional<std::shared_ptr<HybridTestObjectRustSpec>>& optionalHybrid) override { HybridTestObjectRustSpec_set_optional_hybrid(_rustPtr, [&]() -> void* { struct __Opt { uint8_t has_value; void* value; }; auto __opt = new __Opt(); if (optionalHybrid.has_value()) { const auto& __inner = optionalHybrid.value(); __opt->has_value = 1; __opt->value = static_cast<void*>(new std::shared_ptr<HybridTestObjectRustSpec>(__inner)); } else { __opt->has_value = 0; __opt->value = {}; } return static_cast<void*>(__opt); }()); }
    ...
    inline std::string getStringValue() override { return ([](const char* __p) -> std::string { std::string __s(__p); __nitrogen_free_cstring(const_cast<char*>(__p)); return __s; })(HybridTestObjectRustSpec_get_string_value(_rustPtr)); }
    ...
    inline std::optional<std::string> getOptionalString() override { return [&]() -> std::optional<std::string> { struct __Opt { uint8_t has_value; const char* value; }; auto __s = static_cast<__Opt*>(HybridTestObjectRustSpec_get_optional_string(_rustPtr)); std::optional<std::string> __r; if (__s->has_value) { __r = ([](const char* __p) -> std::string { std::string __s(__p); __nitrogen_free_cstring(const_cast<char*>(__p)); return __s; })(__s->value); } delete __s; return __r; }(); }
    inline void setOptionalString(const std::optional<std::string>& optionalString) override { HybridTestObjectRustSpec_set_optional_string(_rustPtr, [&]() -> void* { struct __Opt { uint8_t has_value; const char* value; }; auto __opt = new __Opt(); if (optionalString.has_value()) { const auto& __inner = optionalString.value(); __opt->has_value = 1; __opt->value = __inner.c_str(); } else { __opt->has_value = 0; __opt->value = {}; } return static_cast<void*>(__opt); }()); }
    inline std::optional<std::string> getStringOrUndefined() override { return [&]() -> std::optional<std::string> { struct __Opt { uint8_t has_value; const char* value; }; auto __s = static_cast<__Opt*>(HybridTestObjectRustSpec_get_string_or_undefined(_rustPtr)); std::optional<std::string> __r; if (__s->has_value) { __r = ([](const char* __p) -> std::string { std::string __s(__p); __nitrogen_free_cstring(const_cast<char*>(__p)); return __s; })(__s->value); } delete __s; return __r; }(); }
    inline void setStringOrUndefined(const std::optional<std::string>& stringOrUndefined) override { HybridTestObjectRustSpec_set_string_or_undefined(_rustPtr, [&]() -> void* { struct __Opt { uint8_t has_value; const char* value; }; auto __opt = new __Opt(); if (stringOrUndefined.has_value()) { const auto& __inner = stringOrUndefined.value(); __opt->has_value = 1; __opt->value = __inner.c_str(); } else { __opt->has_value = 0; __opt->value = {}; } return static_cast<void*>(__opt); }()); }
    ...
    inline std::optional<std::vector<std::string>> getOptionalArray() override { return [&]() -> std::optional<std::vector<std::string>> { struct __Opt { uint8_t has_value; void* value; }; auto __s = static_cast<__Opt*>(HybridTestObjectRustSpec_get_optional_array(_rustPtr)); std::optional<std::vector<std::string>> __r; if (__s->has_value) { __r = std::move(*static_cast<std::vector<std::string>*>(__s->value)); } delete __s; return __r; }(); }
    inline void setOptionalArray(const std::optional<std::vector<std::string>>& optionalArray) override { HybridTestObjectRustSpec_set_optional_array(_rustPtr, [&]() -> void* { struct __Opt { uint8_t has_value; void* value; }; auto __opt = new __Opt(); if (optionalArray.has_value()) { const auto& __inner = optionalArray.value(); __opt->has_value = 1; __opt->value = static_cast<void*>(new std::vector<std::string>(std::move(__inner))); } else { __opt->has_value = 0; __opt->value = {}; } return static_cast<void*>(__opt); }()); }
    inline std::optional<Powertrain> getOptionalEnum() override { return [&]() -> std::optional<Powertrain> { struct __Opt { uint8_t has_value; int32_t value; }; auto __s = static_cast<__Opt*>(HybridTestObjectRustSpec_get_optional_enum(_rustPtr)); std::optional<Powertrain> __r; if (__s->has_value) { __r = static_cast<Powertrain>(__s->value); } delete __s; return __r; }(); }
    inline void setOptionalEnum(std::optional<Powertrain> optionalEnum) override { HybridTestObjectRustSpec_set_optional_enum(_rustPtr, [&]() -> void* { struct __Opt { uint8_t has_value; int32_t value; }; auto __opt = new __Opt(); if (optionalEnum.has_value()) { const auto& __inner = optionalEnum.value(); __opt->has_value = 1; __opt->value = static_cast<int32_t>(__inner); } else { __opt->has_value = 0; __opt->value = {}; } return static_cast<void*>(__opt); }()); }
    inline std::optional<OldEnum> getOptionalOldEnum() override { return [&]() -> std::optional<OldEnum> { struct __Opt { uint8_t has_value; int32_t value; }; auto __s = static_cast<__Opt*>(HybridTestObjectRustSpec_get_optional_old_enum(_rustPtr)); std::optional<OldEnum> __r; if (__s->has_value) { __r = static_cast<OldEnum>(__s->value); } delete __s; return __r; }(); }
    inline void setOptionalOldEnum(std::optional<OldEnum> optionalOldEnum) override { HybridTestObjectRustSpec_set_optional_old_enum(_rustPtr, [&]() -> void* { struct __Opt { uint8_t has_value; int32_t value; }; auto __opt = new __Opt(); if (optionalOldEnum.has_value()) { const auto& __inner = optionalOldEnum.value(); __opt->has_value = 1; __opt->value = static_cast<int32_t>(__inner); } else { __opt->has_value = 0; __opt->value = {}; } return static_cast<void*>(__opt); }()); }
    inline std::optional<std::function<void(double /* value */)>> getOptionalCallback() override { return [&]() -> std::optional<std::function<void(double /* value */)>> { struct __Opt { uint8_t has_value; void* value; }; auto __s = static_cast<__Opt*>(HybridTestObjectRustSpec_get_optional_callback(_rustPtr)); std::optional<std::function<void(double /* value */)>> __r; if (__s->has_value) { __r = std::move(*static_cast<std::function<void(double /* value */)>*>(__s->value)); } delete __s; return __r; }(); }
    inline void setOptionalCallback(const std::optional<std::function<void(double /* value */)>>& optionalCallback) override { HybridTestObjectRustSpec_set_optional_callback(_rustPtr, [&]() -> void* { struct __Opt { uint8_t has_value; void* value; }; auto __opt = new __Opt(); if (optionalCallback.has_value()) { const auto& __inner = optionalCallback.value(); __opt->has_value = 1; __opt->value = [&]() -> void* { struct __W { void(*fn_ptr)(void*, double); void* userdata; void(*destroy_fn)(void*); }; return static_cast<void*>(new __W { [](void* __ud, double __a0) { (*static_cast<std::function<void(double /* value */)>*>(__ud))(__a0); }, static_cast<void*>(new std::function<void(double /* value */)>(std::move(__inner))), [](void* __ud) { delete static_cast<std::function<void(double /* value */)>*>(__ud); } }); }(); } else { __opt->has_value = 0; __opt->value = {}; } return static_cast<void*>(__opt); }()); }
  ...
  public:
    ...
    inline std::string addStrings(const std::string& a, const std::string& b) override { auto __result = HybridTestObjectRustSpec_add_strings(_rustPtr, a.c_str(), b.c_str()); return ([](const char* __p) -> std::string { std::string __s(__p); __nitrogen_free_cstring(const_cast<char*>(__p)); return __s; })(__result); }
    ...
    inline nitro::NullType bounceNull() override { return HybridTestObjectRustSpec_bounce_null(_rustPtr); }
    ...
    inline std::string sumUpAllPassengers(const std::vector<Car>& cars) override { auto __result = HybridTestObjectRustSpec_sum_up_all_passengers(_rustPtr, static_cast<void*>(new std::vector<Car>(std::move(cars)))); return ([](const char* __p) -> std::string { std::string __s(__p); __nitrogen_free_cstring(const_cast<char*>(__p)); return __s; })(__result); }
    ...
    inline std::string tryOptionalParams(double num, bool boo, const std::optional<std::string>& str) override { auto __result = HybridTestObjectRustSpec_try_optional_params(_rustPtr, num, boo, [&]() -> void* { struct __Opt { uint8_t has_value; const char* value; }; auto __opt = new __Opt(); if (str.has_value()) { const auto& __inner = str.value(); __opt->has_value = 1; __opt->value = __inner.c_str(); } else { __opt->has_value = 0; __opt->value = {}; } return static_cast<void*>(__opt); }()); return ([](const char* __p) -> std::string { std::string __s(__p); __nitrogen_free_cstring(const_cast<char*>(__p)); return __s; })(__result); }
    inline std::string tryMiddleParam(double num, std::optional<bool> boo, const std::string& str) override { auto __result = HybridTestObjectRustSpec_try_middle_param(_rustPtr, num, [&]() -> void* { struct __Opt { uint8_t has_value; bool value; }; auto __opt = new __Opt(); if (boo.has_value()) { __opt->has_value = 1; __opt->value = static_cast<bool>(boo.value()); } else { __opt->has_value = 0; __opt->value = {}; } return static_cast<void*>(__opt); }(), str.c_str()); return ([](const char* __p) -> std::string { std::string __s(__p); __nitrogen_free_cstring(const_cast<char*>(__p)); return __s; })(__result); }
    inline std::optional<Powertrain> tryOptionalEnum(std::optional<Powertrain> value) override { auto __result = HybridTestObjectRustSpec_try_optional_enum(_rustPtr, [&]() -> void* { struct __Opt { uint8_t has_value; int32_t value; }; auto __opt = new __Opt(); if (value.has_value()) { const auto& __inner = value.value(); __opt->has_value = 1; __opt->value = static_cast<int32_t>(__inner); } else { __opt->has_value = 0; __opt->value = {}; } return static_cast<void*>(__opt); }()); return [&]() -> std::optional<Powertrain> { struct __Opt { uint8_t has_value; int32_t value; }; auto __s = static_cast<__Opt*>(__result); std::optional<Powertrain> __r; if (__s->has_value) { __r = static_cast<Powertrain>(__s->value); } delete __s; return __r; }(); }
    inline bool tryTrailingOptional(double num, const std::string& str, std::optional<bool> boo) override { return HybridTestObjectRustSpec_try_trailing_optional(_rustPtr, num, str.c_str(), [&]() -> void* { struct __Opt { uint8_t has_value; bool value; }; auto __opt = new __Opt(); if (boo.has_value()) { __opt->has_value = 1; __opt->value = static_cast<bool>(boo.value()); } else { __opt->has_value = 0; __opt->value = {}; } return static_cast<void*>(__opt); }()); }
    ...
    inline std::shared_ptr<Promise<std::optional<double>>> promiseThatResolvesToUndefined() override {
          return Promise<std::optional<double>>::async([=]() -> std::optional<double> {
            ...
            return [&]() -> std::optional<double> { struct __Opt { uint8_t has_value; double value; }; auto __s = static_cast<__Opt*>(__result); std::optional<double> __r; if (__s->has_value) { __r = static_cast<double>(__s->value); } delete __s; return __r; }();
          });
        }
    ...
    inline void callWithOptional(std::optional<double> value, const std::function<void(std::optional<double> /* maybe */)>& callback) override { HybridTestObjectRustSpec_call_with_optional(_rustPtr, [&]() -> void* { struct __Opt { uint8_t has_value; double value; }; auto __opt = new __Opt(); if (value.has_value()) { __opt->has_value = 1; __opt->value = static_cast<double>(value.value()); } else { __opt->has_value = 0; __opt->value = {}; } return static_cast<void*>(__opt); }(), [&]() -> void* { struct __W { void(*fn_ptr)(void*, void*); void* userdata; void(*destroy_fn)(void*); }; return static_cast<void*>(new __W { [](void* __ud, void* __a0) { (*static_cast<std::function<void(std::optional<double> /* maybe */)>*>(__ud))([&]() -> std::optional<double> { struct __Opt { uint8_t has_value; double value; }; auto __s = static_cast<__Opt*>(__a0); std::optional<double> __r; if (__s->has_value) { __r = static_cast<double>(__s->value); } delete __s; return __r; }()); }, static_cast<void*>(new std::function<void(std::optional<double> /* maybe */)>(std::move(callback))), [](void* __ud) { delete static_cast<std::function<void(std::optional<double> /* maybe */)>*>(__ud); } }); }()); }
    ...
    inline std::optional<Person> getDriver(const Car& car) override { auto __result = HybridTestObjectRustSpec_get_driver(_rustPtr, static_cast<void*>(new Car(car))); return [&]() -> std::optional<Person> { struct __Opt { uint8_t has_value; void* value; }; auto __s = static_cast<__Opt*>(__result); std::optional<Person> __r; if (__s->has_value) { __r = *static_cast<Person*>(__s->value); } delete __s; return __r; }(); }
    ...
    inline std::shared_ptr<HybridChildSpec> bounceChild(const std::shared_ptr<HybridChildSpec>& child) override { auto __result = HybridTestObjectRustSpec_bounce_child(_rustPtr, static_cast<void*>(new std::shared_ptr<HybridChildSpec>(child))); return __result; }
    inline std::shared_ptr<HybridBaseSpec> bounceBase(const std::shared_ptr<HybridBaseSpec>& base) override { auto __result = HybridTestObjectRustSpec_bounce_base(_rustPtr, static_cast<void*>(new std::shared_ptr<HybridBaseSpec>(base))); return __result; }
    inline std::shared_ptr<HybridBaseSpec> bounceChildBase(const std::shared_ptr<HybridChildSpec>& child) override { auto __result = HybridTestObjectRustSpec_bounce_child_base(_rustPtr, static_cast<void*>(new std::shared_ptr<HybridChildSpec>(child))); return __result; }
    inline std::shared_ptr<HybridChildSpec> castBase(const std::shared_ptr<HybridBaseSpec>& base) override { auto __result = HybridTestObjectRustSpec_cast_base(_rustPtr, static_cast<void*>(new std::shared_ptr<HybridBaseSpec>(base))); return __result; }
    ...
    inline bool getIsViewBlue(const std::shared_ptr<HybridTestViewSpec>& view) override { return HybridTestObjectRustSpec_get_is_view_blue(_rustPtr, static_cast<void*>(new std::shared_ptr<HybridTestViewSpec>(view))); }
    inline std::shared_ptr<margelo::nitro::test::external::HybridSomeExternalObjectSpec> bounceExternalHybrid(const std::shared_ptr<margelo::nitro::test::external::HybridSomeExternalObjectSpec>& externalObject) override { auto __result = HybridTestObjectRustSpec_bounce_external_hybrid(_rustPtr, static_cast<void*>(new std::shared_ptr<margelo::nitro::test::external::HybridSomeExternalObjectSpec>(externalObject))); return __result; }
