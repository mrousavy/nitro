...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::test::NitroHeader> final {
    static inline margelo::nitro::test::NitroHeader fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::test::NitroHeader(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::test::NitroHeader& arg) {
