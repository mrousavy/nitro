...
namespace margelo::nitro::test {
  ...
  void HybridTestObjectSwiftKotlinSpec::loadHybridMethods() {
    ...
    registerHybrids(this, [](Prototype& prototype) {
      ...
      prototype.registerHybridMethod("bounceSelfReferentialStruct", &HybridTestObjectSwiftKotlinSpec::bounceSelfReferentialStruct);
      prototype.registerHybridMethod("bounceTreeNode", &HybridTestObjectSwiftKotlinSpec::bounceTreeNode);
      prototype.registerHybridMethod("bounceTreeNodeMap", &HybridTestObjectSwiftKotlinSpec::bounceTreeNodeMap);
