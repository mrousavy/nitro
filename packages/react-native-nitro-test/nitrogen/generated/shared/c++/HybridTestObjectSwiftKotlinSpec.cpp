...
namespace margelo::nitro::test {
  ...
  void HybridTestObjectSwiftKotlinSpec::loadHybridMethods() {
    ...
    registerHybrids(this, [](Prototype& prototype) {
      ...
      prototype.registerHybridGetter("coordinates", &HybridTestObjectSwiftKotlinSpec::getCoordinates);
      prototype.registerHybridSetter("coordinates", &HybridTestObjectSwiftKotlinSpec::setCoordinates);
