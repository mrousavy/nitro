...
namespace margelo::nitro::test {
  ...
  class HybridTestObjectSwiftKotlinSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::shared_ptr<Promise<Car>> callbacksPutPersonInCar(const std::function<void(const Person& /* person */)>& first, const std::function<void(const Car& /* car */)>& second) = 0;
