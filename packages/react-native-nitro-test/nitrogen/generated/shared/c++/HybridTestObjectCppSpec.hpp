...
namespace margelo::nitro::test {
  ...
  class HybridTestObjectCppSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::shared_ptr<ArrayBuffer> createGpuBuffer(double width, double height, double layers, GpuBufferFormat format) = 0;
      virtual bool isGpuBuffer(const std::shared_ptr<ArrayBuffer>& buffer) = 0;
      virtual bool testGpuBufferIdentity() = 0;
