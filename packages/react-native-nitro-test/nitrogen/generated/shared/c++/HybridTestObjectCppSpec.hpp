...
namespace margelo::nitro::test {
  ...
  class HybridTestObjectCppSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual SelfReferentialStruct bounceSelfReferentialStruct(const SelfReferentialStruct& value) = 0;
      virtual TreeNode bounceTreeNode(const TreeNode& node) = 0;
      virtual TreeNodeMap bounceTreeNodeMap(const TreeNodeMap& node) = 0;
