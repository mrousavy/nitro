...
namespace margelo::nitro::test {
  ...
  class HybridTestObjectCppSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::shared_ptr<HybridTestObjectCppSpec> getThisObject() = 0;
      virtual std::optional<std::shared_ptr<HybridTestObjectCppSpec>> getOptionalHybrid() = 0;
      virtual void setOptionalHybrid(const std::optional<std::shared_ptr<HybridTestObjectCppSpec>>& optionalHybrid) = 0;
    ...
    public:
      ...
      virtual std::shared_ptr<Promise<std::vector<NitroRequest>>> bounceNitroRequests(const std::vector<NitroRequest>& array) = 0;
      virtual std::shared_ptr<Promise<std::vector<NitroResponse>>> bounceNitroResponses(const std::vector<NitroResponse>& array) = 0;
