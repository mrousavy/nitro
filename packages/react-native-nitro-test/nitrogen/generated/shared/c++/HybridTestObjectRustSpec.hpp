...
// Forward declaration of `HybridTestObjectRustSpec` to properly resolve imports.
namespace margelo::nitro::test { class HybridTestObjectRustSpec; }
...
namespace margelo::nitro::test {
  ...
  class HybridTestObjectRustSpec: public virtual HybridObject {
    ...
    public:
      // Properties
      virtual std::shared_ptr<HybridTestObjectRustSpec> getThisObject() = 0;
      virtual std::optional<std::shared_ptr<HybridTestObjectRustSpec>> getOptionalHybrid() = 0;
      virtual void setOptionalHybrid(const std::optional<std::shared_ptr<HybridTestObjectRustSpec>>& optionalHybrid) = 0;
    ...
    public:
      // Methods
      virtual std::shared_ptr<HybridTestObjectRustSpec> newTestObject() = 0;
      virtual std::variant<std::shared_ptr<HybridTestObjectRustSpec>, Person> getVariantHybrid(const std::variant<std::shared_ptr<HybridTestObjectRustSpec>, Person>& variant) = 0;
      ...
      virtual std::shared_ptr<Promise<void>> callCallbackThatReturnsPromiseVoid(const std::function<std::shared_ptr<Promise<std::shared_ptr<Promise<void>>>>()>& callback) = 0;
