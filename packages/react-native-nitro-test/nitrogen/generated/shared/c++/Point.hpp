...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::test::Point> final {
    static inline margelo::nitro::test::Point fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::test::Point(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::test::Point& arg) {
