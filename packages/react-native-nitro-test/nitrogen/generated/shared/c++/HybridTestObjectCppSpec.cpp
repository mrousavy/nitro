...
namespace margelo::nitro::test {
  ...
  void HybridTestObjectCppSpec::loadHybridMethods() {
    ...
    registerHybrids(this, [](Prototype& prototype) {
      ...
      prototype.registerHybridMethod("bounceSelfReferentialStruct", &HybridTestObjectCppSpec::bounceSelfReferentialStruct);
      prototype.registerHybridMethod("bounceTreeNode", &HybridTestObjectCppSpec::bounceTreeNode);
      prototype.registerHybridMethod("bounceTreeNodeMap", &HybridTestObjectCppSpec::bounceTreeNodeMap);
