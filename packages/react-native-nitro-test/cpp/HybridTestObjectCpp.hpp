...
public:
  ...
  std::shared_ptr<margelo::nitro::nitrotestexternal::HybridSomeExternalObjectSpec>
  bounceExternalHybrid(const std::shared_ptr<margelo::nitro::nitrotestexternal::HybridSomeExternalObjectSpec>& externalObject) override;
