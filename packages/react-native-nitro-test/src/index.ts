...
import { type SomeExternalObjectSubclass } from './specs/SomeExternalObjectSubclass.nitro'
...
export const HybridSomeExternalObjectSubclass =
  NitroModules.createHybridObject<SomeExternalObjectSubclass>(
