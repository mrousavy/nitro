...
- [`android/`](android): All your `android`-specific implementations.
  ...
  - [`src/main/java/com/margelo/nitro/$$androidNamespace$$/`](android/src/main/java/com/margelo/nitro/$$androidNamespace$$/): All Kotlin implementations.
    - [`$$androidCxxLibName$$Package.kt`](android/src/main/java/com/margelo/nitro/$$androidNamespace$$/$$androidCxxLibName$$Package.kt): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.kt` file. In here, you can autolink all Kotlin HybridObjects.
