...
abstract class HybridImageFactorySpec: HybridObject {
  /**
   * Default-initialize this `HybridImageFactorySpec`.
   * Use this constructor if `HybridImageFactorySpec` has no child-classes.
   */
  constructor(): super(initHybrid()) { }

  /**
   * Initialize this `HybridImageFactorySpec` from a child-class
   * with a custom `HybridData` being passed upwards.
   * Use this constructor if `HybridImageFactorySpec` is being initialized from a child-class.
   */
