...
abstract class HybridImageFactory: HybridObject() {
  ...
  @DoNotStrip
  @Keep
  abstract fun loadImageFromFile(path: String): HybridImage
  
  @DoNotStrip
  @Keep
  abstract fun loadImageFromURL(path: String): HybridImage
  
  @DoNotStrip
  @Keep
  abstract fun loadImageFromSystemName(path: String): HybridImage
  
  @DoNotStrip
  @Keep
  abstract fun bounceBack(image: HybridImage): HybridImage

  companion object {
    private const val TAG = "HybridImageFactory"
    init {
      try {
