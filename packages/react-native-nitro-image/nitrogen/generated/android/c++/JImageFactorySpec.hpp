...
namespace margelo::nitro::image {
  ...
  class JImageFactorySpec: public jni::HybridClass<JImageFactorySpec>, public HybridImageFactory {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/image/ImageFactorySpec;";
    static jni::local_ref<jhybriddata> initHybrid(jni::alias_ref<jhybridobject> jThis);
    static void registerNatives();

  private:
    // C++ constructor (called from Java via `initHybrid()`)
    explicit JImageFactorySpec(jni::alias_ref<jhybridobject> jThis) : _javaPart(jni::make_global(jThis)) {}
  ...
  private:
    friend HybridBase;
    jni::global_ref<JImageFactorySpec::javaobject> _javaPart;
  };
