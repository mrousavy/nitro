...
namespace margelo::nitro::image {
  ...
  public:
    // Properties
    std::string getSomeProp() override;
    void setSomeProp(const std::string& someProp) override;
    std::function<void(double /* value */)> getSomeCallback() override;
    void setSomeCallback(const std::function<void(double /* value */)>& someCallback) override;

  public:
    // Methods
    double someRefMethod() override;
