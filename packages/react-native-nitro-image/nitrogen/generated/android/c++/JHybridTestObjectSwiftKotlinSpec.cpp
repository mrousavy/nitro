...
namespace margelo::nitro::image {
  ...
  std::string JHybridTestObjectSwiftKotlinSpec::getStringValue() {
    static const auto method = _javaPart->getClass()->getMethod<jni::JString()>("getStringValue");
    auto result = method(_javaPart);
  ...
  std::optional<std::string> JHybridTestObjectSwiftKotlinSpec::getStringOrUndefined() {
    static const auto method = _javaPart->getClass()->getMethod<jni::JString()>("getStringOrUndefined");
    auto result = method(_javaPart);
  ...
  std::optional<std::string> JHybridTestObjectSwiftKotlinSpec::getStringOrNull() {
    static const auto method = _javaPart->getClass()->getMethod<jni::JString()>("getStringOrNull");
    auto result = method(_javaPart);
    return result != nullptr ? std::make_optional(result->toStdString()) : std::nullopt;
  }
  ...
  std::optional<std::string> JHybridTestObjectSwiftKotlinSpec::getOptionalString() {
    static const auto method = _javaPart->getClass()->getMethod<jni::JString()>("getOptionalString");
    auto result = method(_javaPart);
    return result != nullptr ? std::make_optional(result->toStdString()) : std::nullopt;
  }
  ...
  std::shared_ptr<margelo::nitro::image::HybridTestObjectSwiftKotlinSpec> JHybridTestObjectSwiftKotlinSpec::getThisObject() {
    static const auto method = _javaPart->getClass()->getMethod<JHybridTestObjectSwiftKotlinSpec::javaobject()>("getThisObject");
    auto result = method(_javaPart);
  ...
  std::string JHybridTestObjectSwiftKotlinSpec::addStrings(const std::string& a, const std::string& b) {
    static const auto method = _javaPart->getClass()->getMethod<jni::JString(jni::alias_ref<jni::JString> /* a */, jni::alias_ref<jni::JString> /* b */)>("addStrings");
  ...
  std::shared_ptr<AnyMap> JHybridTestObjectSwiftKotlinSpec::createMap() {
    static const auto method = _javaPart->getClass()->getMethod<JAnyMap::javaobject()>("createMap");
    auto result = method(_javaPart);
  ...
  std::shared_ptr<AnyMap> JHybridTestObjectSwiftKotlinSpec::mapRoundtrip(const std::shared_ptr<AnyMap>& map) {
    static const auto method = _javaPart->getClass()->getMethod<JAnyMap::javaobject(jni::alias_ref<JAnyMap::javaobject> /* map */)>("mapRoundtrip");
  ...
  std::string JHybridTestObjectSwiftKotlinSpec::tryOptionalParams(double num, bool boo, const std::optional<std::string>& str) {
    static const auto method = _javaPart->getClass()->getMethod<jni::JString(double /* num */, jboolean /* boo */, jni::alias_ref<jni::JString> /* str */)>("tryOptionalParams");
  ...
  std::string JHybridTestObjectSwiftKotlinSpec::tryMiddleParam(double num, std::optional<bool> boo, const std::string& str) {
    static const auto method = _javaPart->getClass()->getMethod<jni::JString(double /* num */, jni::alias_ref<jni::JBoolean> /* boo */, jni::alias_ref<jni::JString> /* str */)>("tryMiddleParam");
  ...
  std::optional<Powertrain> JHybridTestObjectSwiftKotlinSpec::tryOptionalEnum(std::optional<Powertrain> value) {
    static const auto method = _javaPart->getClass()->getMethod<JPowertrain(jni::alias_ref<JPowertrain> /* value */)>("tryOptionalEnum");
  ...
  std::future<int64_t> JHybridTestObjectSwiftKotlinSpec::calculateFibonacciAsync(double value) {
    static const auto method = _javaPart->getClass()->getMethod<JPromise::javaobject(double /* value */)>("calculateFibonacciAsync");
    auto result = method(_javaPart, value);
    return [&]() {
  ...
  std::future<void> JHybridTestObjectSwiftKotlinSpec::wait(double seconds) {
    static const auto method = _javaPart->getClass()->getMethod<JPromise::javaobject(double /* seconds */)>("wait");
  ...
  Car JHybridTestObjectSwiftKotlinSpec::getCar() {
    static const auto method = _javaPart->getClass()->getMethod<JCar()>("getCar");
    auto result = method(_javaPart);
    return result->toCpp();
  }
  ...
  std::optional<Person> JHybridTestObjectSwiftKotlinSpec::getDriver(const Car& car) {
    static const auto method = _javaPart->getClass()->getMethod<JPerson(jni::alias_ref<JCar> /* car */)>("getDriver");
    auto result = method(_javaPart, JCar::fromCpp(car));
    return result != nullptr ? std::make_optional(result->toCpp()) : std::nullopt;
  }
  std::shared_ptr<ArrayBuffer> JHybridTestObjectSwiftKotlinSpec::createArrayBuffer() {
    static const auto method = _javaPart->getClass()->getMethod<JArrayBuffer::javaobject()>("createArrayBuffer");
    auto result = method(_javaPart);
  ...
  std::shared_ptr<margelo::nitro::image::HybridTestObjectSwiftKotlinSpec> JHybridTestObjectSwiftKotlinSpec::newTestObject() {
    static const auto method = _javaPart->getClass()->getMethod<JHybridTestObjectSwiftKotlinSpec::javaobject()>("newTestObject");
    auto result = method(_javaPart);
    return JNISharedPtr::make_shared_from_jni<JHybridTestObjectSwiftKotlinSpec>(jni::make_global(result));
  }
