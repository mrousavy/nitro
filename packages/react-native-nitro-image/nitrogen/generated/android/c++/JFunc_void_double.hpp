...
namespace margelo::nitro::image {
  ...
  public:
    static jni::local_ref<JFunc_void_double::javaobject> fromCpp(const std::function<void(double /* maybe */)>& func) {
      return JFunc_void_double::newObjectCxxArgs(func);
    }

  public:
    void call(const double& maybe) {
      return _func(maybe);
    }
  ...
  private:
    explicit JFunc_void_double(const std::function<void(double /* maybe */)>& func): _func(func) { }

  private:
    friend HybridBase;
    std::function<void(double /* maybe */)> _func;
  };
