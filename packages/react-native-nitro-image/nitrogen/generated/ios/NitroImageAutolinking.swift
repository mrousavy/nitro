...
public final class NitroImageAutolinking {
  ...
  /**
   * Creates an instance of a Swift class that implements `HybridViewWithChildrenSpec`,
   * and wraps it in a Swift class that can directly interop with C++ (`HybridViewWithChildrenSpec_cxx`)
   *
   * This is generated by Nitrogen and will initialize the class specified
   * in the `"autolinking"` property of `nitro.json` (in this case, `HybridViewWithChildren`).
   */
  public static func createViewWithChildren() -> bridge.std__shared_ptr_margelo__nitro__image__HybridViewWithChildrenSpec_ {
    let hybridObject = HybridViewWithChildren()
    return { () -> bridge.std__shared_ptr_margelo__nitro__image__HybridViewWithChildrenSpec_ in
      let __cxxWrapped = hybridObject.getCxxWrapper()
      return __cxxWrapped.getCxxPart()
    }()
  }
