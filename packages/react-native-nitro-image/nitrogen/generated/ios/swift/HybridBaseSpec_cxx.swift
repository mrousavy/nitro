...
/**
 * Helper class for converting instances of `HybridBaseSpec_cxx` from- and to unsafe pointers.
 ...
 */
public final class HybridBaseSpec_cxx_unsafe {
  /**
   * Casts a `HybridBaseSpec_cxx` instance to a retained unsafe raw pointer.
   * This acquires one additional strong reference on the object!
   */
  public static func toUnsafe(_ instance: HybridBaseSpec_cxx) -> UnsafeMutableRawPointer {
   ...
   */
  public static func fromUnsafe(_ pointer: UnsafeMutableRawPointer) -> HybridBaseSpec_cxx {
