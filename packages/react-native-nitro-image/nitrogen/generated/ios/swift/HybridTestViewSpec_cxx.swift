...
public class HybridTestViewSpec_cxx {
  ...
  // Properties
  public var someProp: std.string {
    @inline(__always)
    get {
      return std.string(self.__implementation.someProp)
    }
    @inline(__always)
    set {
      self.__implementation.someProp = String(newValue)
    }
  }
  ...
  // Methods
  @inline(__always)
  public func someRefMethod() -> bridge.Result_double_ {
    do {
      let __result = try self.__implementation.someRefMethod()
