...
public protocol HybridTestObjectSwiftKotlinSpec: AnyObject, HybridObjectSpec {
  // Properties
  var thisObject: some HybridTestObjectSwiftKotlinSpec { get }
  ...
  // Methods
  func newTestObject() throws -> some HybridTestObjectSwiftKotlinSpec
  ...
  func createChild() throws -> some HybridChildSpec
  func createBase() throws -> some HybridBaseSpec
  func createBaseActualChild() throws -> some HybridBaseSpec
  func bounceChild(child: some HybridChildSpec) throws -> some HybridChildSpec
  func bounceBase(base: some HybridBaseSpec) throws -> some HybridBaseSpec
  func bounceChildBase(child: some HybridChildSpec) throws -> some HybridBaseSpec
  func castBase(base: some HybridBaseSpec) throws -> some HybridChildSpec
}
