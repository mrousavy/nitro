...
public class HybridBaseSpecCxx {
  ...
  public static func __putHybridBaseSpecCxx(_ instance: HybridBaseSpecCxx) -> Int {
    let id = __counter
    __counter += 1
  ...
  public static func __getHybridBaseSpecCxxById(_ instanceId: Int) -> HybridBaseSpecCxx {
