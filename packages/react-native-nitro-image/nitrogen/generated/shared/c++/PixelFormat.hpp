...
template <> struct JSIConverter<PixelFormat> {
  static inline PixelFormat fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
    ...
    switch (hashString(unionValue.c_str(), unionValue.size())) {
      ...
      default:
        [[unlikely]] throw std::runtime_error("Cannot convert " + unionValue + " to PixelFormat - invalid value!");
    }
  }
  static inline jsi::Value toJSI(jsi::Runtime& runtime, PixelFormat arg) {
    switch (arg) {
      case PixelFormat::RGB:
        return JSIConverter<std::string>::toJSI(runtime, "rgb");
      case PixelFormat::YUV_8BIT:
        return JSIConverter<std::string>::toJSI(runtime, "yuv-8bit");
      case PixelFormat::YUV_10BIT:
        return JSIConverter<std::string>::toJSI(runtime, "yuv-10bit");
      default:
        [[unlikely]] throw std::runtime_error("Cannot convert PixelFormat to JS - invalid value: " + std::to_string(static_cast<int>(arg)) +
                                              "!");
    }
  }
};
