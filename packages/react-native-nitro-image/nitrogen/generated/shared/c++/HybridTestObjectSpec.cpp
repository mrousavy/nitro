...
namespace margelo::nitro::image {
  ...
  void HybridTestObjectSpec::loadHybridMethods() {
    ...
    registerHybridMethod("getVariantEnum", &HybridTestObjectSpec::getVariantEnum, this);
    registerHybridMethod("getVariantObjects", &HybridTestObjectSpec::getVariantObjects, this);
    registerHybridMethod("getVariantHybrid", &HybridTestObjectSpec::getVariantHybrid, this);
    registerHybridMethod("getVariantTuple", &HybridTestObjectSpec::getVariantTuple, this);
    ...
    registerHybridMethod("createArrayBuffer", &HybridTestObjectSpec::createArrayBuffer, this);
    registerHybridMethod("getBufferLastItem", &HybridTestObjectSpec::getBufferLastItem, this);
    registerHybridMethod("setAllValuesTo", &HybridTestObjectSpec::setAllValuesTo, this);
