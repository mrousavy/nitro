...
public:
  ...
  std::unordered_map<std::string, std::variant<double, bool>> HybridTestObjectCpp::bounceMap(const std::unordered_map<std::string, std::variant<double, bool>>& map) override;
