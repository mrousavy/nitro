...
- [`android/`](android): All your `android`-specific implementations. (`HybridImage.kt` and `HybridImageFactory.kt`)
  ...
  - [`src/`](android/src)
    - [`main/`](android/src/main)
      - [`java/`](android/src/main/java)
        - [`com/`](android/src/main/java/com)
          - [`margelo/`](android/src/main/java/com/margelo)
            - [`nitro/`](android/src/main/java/com/margelo/nitro)
              - [`image/`](android/src/main/java/com/margelo/nitro/image)
