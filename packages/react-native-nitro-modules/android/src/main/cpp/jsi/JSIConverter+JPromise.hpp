...
struct JSIConverter<JPromise<T>> final {
  ...
  static inline jsi::Value toJSI(jsi::Runtime& runtime, const jni::alias_ref<JPromise<T>>& arg) {
    ...
    return JSPromise::createPromise(runtime, [weakDispatcher, javaPromise](jsi::Runtime& runtime,
                                                                           std::shared_ptr<JSPromise> promise) mutable {
      ...
      javaPromise->addOnResolvedListener([&runtime, weakDispatcher, promise](jni::alias_ref<jni::JObject> result) {
        ...
        dispatcher->runAsync([&runtime, promise, javaResult]() { promise->resolve(runtime, JSIConverter<T>::toJSI(runtime, javaResult)); });
      });
