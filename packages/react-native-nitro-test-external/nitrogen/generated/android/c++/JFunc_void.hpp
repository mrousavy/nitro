...
namespace margelo::nitro::test::external {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/test/external/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/test/external/Func_void_cxx;";
