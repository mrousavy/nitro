...
namespace margelo::nitro::test::external {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/test/external/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/test/external/Func_void_cxx;";
