...
open class HybridSomeExternalObjectSpec_cxx {
   ...
   */
  open class func fromUnsafe(_ pointer: UnsafeMutableRawPointer) -> HybridSomeExternalObjectSpec_cxx {
  ...
  @inline(__always)
  public final func bounceEnum(value: Int32) -> bridge.Result_SomeExternalEnum_ {
    do {
      let __result = try self.__implementation.bounceEnum(value: margelo.nitro.test.external.SomeExternalEnum(rawValue: value)!)
      let __resultCpp = __result
      return bridge.create_Result_SomeExternalEnum_(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_SomeExternalEnum_(__exceptionPtr)
    }
  }
  
  @inline(__always)
  public final func bounceStruct(value: SomeExternalStruct) -> bridge.Result_SomeExternalStruct_ {
    do {
      let __result = try self.__implementation.bounceStruct(value: value)
      let __resultCpp = __result
      return bridge.create_Result_SomeExternalStruct_(__resultCpp)
    } catch (let __error) {
      let __exceptionPtr = __error.toCpp()
      return bridge.create_Result_SomeExternalStruct_(__exceptionPtr)
    }
  }
}
