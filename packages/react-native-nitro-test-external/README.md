...
- [`android/`](android): All your `android`-specific implementations.
  ...
  - [`src/main/java/com/margelo/nitro/test/external/`](android/src/main/java/com/margelo/nitro/test/external/): All Kotlin implementations.
    - [`NitroTestExternalPackage.java`](android/src/main/java/com/margelo/nitro/test/external/NitroTestExternalPackage.java): The react-native package. You need this because the react-native CLI only adds libraries if they have a `*Package.java` file. In here, you can autolink all Kotlin HybridObjects.
